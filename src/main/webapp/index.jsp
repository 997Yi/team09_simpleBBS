                                    ...
                                    <jstl:if test="${adminInfo != null}">
                                        <jstl:if test="${blog.key.top != true}">
                                            <button type="button" class="layui-btn layui-btn-primary">
                                                <a href="${pageContext.request.contextPath}/admin/top?blogId=${blog.key.id}&page=user/listBlog">置顶</a>
                                            </button>
                                        </jstl:if>
                                        <jstl:if test="${blog.key.top == true}">
                                            <button type="button" class="layui-btn layui-btn-primary" >
                                                <a href="${pageContext.request.contextPath}/admin/top?blogId=${blog.key.id}&page=user/listBlog">取消置顶</a>
                                            </button>
                                        </jstl:if>
                                        <jstl:if test="${blog.key.quintessence != true}">
                                            <button type="button" class="layui-btn layui-btn-primary">
                                                <a href="${pageContext.request.contextPath}/admin/quintessence?blogId=${blog.key.id}&page=user/listBlog">精华</a>
                                            </button>
                                        </jstl:if>
                                        <jstl:if test="${blog.key.quintessence == true}">
                                            <button type="button" class="layui-btn layui-btn-primary">
                                                <a href="${pageContext.request.contextPath}/admin/quintessence?blogId=${blog.key.id}&page=user/listBlog">取消精华</a>
                                            </button>
                                        </jstl:if>
                                        <button type="button" class="layui-btn layui-btn-primary">
                                            <a href="${pageContext.request.contextPath}/admin/deleteBlog?blogId=${blog.key.id}&page=user/listBlog">删除</a>
                                        </button>
                                    </jstl:if>
                                </div>
